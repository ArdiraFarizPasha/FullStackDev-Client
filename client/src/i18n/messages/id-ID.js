...
export default {
  [LOCALES.INDONESIA]: {
    //Homepage
    'header': 'Form Deklarasi Kesehatan',
    'home-text': 'Rumah sakit memberlakukan proses skrining untuk mencegah penyebaran COVID-19 dan menurunkan risiko paparan terhadap pengunjung dan staf rumah sakit. Untuk mempercepat proses tersebut, Anda dapat mengisi form digital di bawah ini.',
    'home-list-rules-1': "Mohon isi kuesioner ini pada hari yang sama dengan hari kunjungan ke rumah sakit."
    ,
    'home-list-rules-2' : 'Kuesioner diisi oleh setiap pengunjung rumah sakit.'
    ,
    'home-list-rules-3' : 'Setiap pasien hanya dapat didampingi oleh 1 orang.'
    ,
    'home-list-rules-4' : 'Mohon tunjukkan hasil kuesioner di ponsel Anda kepada staf di pintu masuk'
    ,
    'home-queue': `Pengisian formulir elektronik di Siloam Hospitals akan dilakukan secara bertahap dengan urutan sebagai berikut:`,
    ...
    ,
    'home-end-footer': 'Mohon ikuti prosedur yang berlaku di masing-masing Siloam Hospitals yg Anda kunjungi, sesuai dengan arahan petugas.',
